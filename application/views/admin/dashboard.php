    ...
    <div class="container">
      ...
      <!-- USER PROFILE BLOCK -->
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	      		<dtitle>Admin Profile</dtitle>
	      		<hr>
				<div class="thumbnail">
					<img src="<?php echo base_url('assets/img/face80x80.jpg'); ?>" alt="Marcel Newman" class="img-circle">
				</div><!-- /thumbnail -->
				<h1><?php echo $this->session->userdata('adminName'); ?></h1>
				<h3>United States</h3>
				<br>
					<div class="info-user">
						<a href="<?php echo site_url('admins/read/'.$this->session->userdata('adminId')); ?>"><span aria-hidden="true" class="li_user fs1"></span></a>
						<a href="<?php echo site_url('admins/update/'.$this->session->userdata('adminId')) ?>"><span aria-hidden="true" class="li_settings fs1"></span></a>
						<span aria-hidden="true" class="li_mail fs1"></span>
						<a href="<?php echo site_url('myadmin/logout'); ?>"><span aria-hidden="true" class="li_key fs1"></span></a>
					</div>
				</div>
        </div>
        ...
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	            ...
	            <div class="flexslider">
					<ul class="slides">
						<li><img src="<?php echo base_url('assets/img/slide01.png'); ?>" alt="slider"></li>
						<li><img src="<?php echo base_url('assets/img/slide02.png'); ?>" alt="slider"></li>
					</ul>
            </div>
				<div class="cont">
	  ...
	  <!-- LIVE VISITORS BLOCK -->     
      		<div class="half-unit">
	      		...
	      		<div class="cont">
      			<p><bold>388</bold></p>
      			<p><img src="<?php echo base_url('assets/img/up-small.png'); ?>" alt=""> 412 Max. | <img src="<?php echo base_url('assets/img/down-small.png'); ?>" alt=""> 89 Min.</p>
	      		</div>
      		</div>
	  ...
	  <!-- PAGE VIEWS BLOCK -->     
      		<div class="half-unit">
      			...
      			<p><img src="<?php echo base_url('assets/img/up-small.png'); ?>" alt=""> 23.88%</p>
	      		</div>
      		</div>
      	</div>

<?php $this->load->view('user/incs/main_header.php'); ?>
  <body>
    ...
    <div class="container-fluid">
	    <div class="col-md-1">
	    	<div class="row" style="padding: 0px;border-bottom: 1px solid black;text-align: center;">
		    	<ul class="nav navbar-nav" style="width: 100%">
		            <li class="dropdown" style="width: 100%">
		              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="width: 100%"><i class="fa fa-file-image-o fa-2x" aria-hidden="true"></i>&nbsp;<br/> Photo</a>
		              <ul class="dropdown-menu" style="text-align: left;">
		                <li><a href="#">Add My Photo</a></li>
		                <li><a href="#">Add Stock Photo</a></li>
		                <li><a href="#">Add Facebook Photo</a></li>
		              </ul>
		            </li>
		        </ul>
	        </div>
	        <div class="row" style="padding: 0px;border-bottom: 1px solid black;text-align: center;">
		    	<ul class="nav navbar-nav" style="width: 100%">
		            <li class="dropdown" style="width: 100%">
		              ...
		              <ul class="dropdown-menu" style="text-align: left;">
		                <li><a href="#">Add Plain Text</a></li>
		                <li><a href="#">Add Fancy Text</a></li>
		              </ul>
		            </li>
		        </ul>
	        </div>
		    	...
		    	<ul class="nav navbar-nav" style="width: 100%">
		            <li class="dropdown" style="width: 100%">
		              ...
		              <ul class="dropdown-menu" style="text-align: left;">
		                ...
		                <li><a href="#">Gradiant</a></li>
		                <li><a href="#">Upload Background</a></li>
	    ...
	    <div class="col-md-3" style="textoverflow: auto; background-color: #FFFFFF;">
	    	...
	    	<div id="Background" style="min-height: 482px;">
	                ...
	                <div class="row" style="margin-bottom: 15px;margin-top: 15px;">
	                	<div class="col-xs-4 col-md-4" align="center">Color</div>

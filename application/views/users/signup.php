...
<div class="container">
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="row">
				<?php if(is_array(validation_errors_array()) && !empty(validation_errors_array()))
				{?>
				<div class="container error_message">
					<div class="row">
						<div class="col-md-4 col-md-offset-4 text-center">
							<div class="alert  alert-warning"  style="background:white">
								<?=current(validation_errors_array())?>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="login_wrapper">
						<div id="register" class="animate form registration_form">
							<section class="login_content">
								<form action="<?=site_url('login/signup_action')?>" method="post">
									<h1>Sign Up</h1>
